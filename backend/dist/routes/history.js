    ...
    router.get('/:address', async (req, res) => {
        try {
            ...
            const stmt = db.prepare(`
                ...
                LIMIT ? OFFSET ?
            `);
            const transactions = stmt.all(normalizedAddress, normalizedAddress, limit, offset);
            ...
            const eventsStmt = db.prepare(`
                ...
                LIMIT ? OFFSET ?
            `);
            const events = eventsStmt.all(normalizedAddress, normalizedAddress, limit, offset);
