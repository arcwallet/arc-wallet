...
class PolicyEngine {
     ...
     */
    async checkPolicies(sender, estimatedCost) {
        const policies = [
     ...
     */
    setRateLimitPolicy(enabled, maxOpsPerHour) {
     ...
     */
    setBudgetPolicy(enabled, maxCostPerOp, dailyBudget) {
     ...
     */
    recordSponsorship(sender, actualCost) {
        // Update budget
...
class BudgetPolicy {
    ...
    async check(sender, estimatedCost) {
